This microservice is for adding and fetching records in DynamoDB Table BookmarkedHotels. WebIdentityToken is used since IAM for service accounts has been used. 
