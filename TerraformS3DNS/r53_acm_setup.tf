...
resource "aws_route53_record" "apps_dns" {
  ...
  type    = "A"
  alias {
    name                   = aws_cloudfront_distribution.travel_service_distribution.domain_name
    zone_id                = aws_cloudfront_distribution.travel_service_distribution.hosted_zone_id
