...
public class AuthenticationFilter implements GlobalFilter {
			...
			if (routerValidator.isSecured.test(request)) {
				...
				if (token != null) {
					...
					if (username != null) {
						...
						this.populateRequestWithHeaders(exchange, username);
					}
				}
	...
	private void populateRequestWithHeaders(ServerWebExchange exchange, String userName) {
		
		exchange.getRequest().mutate().header("userName", String.valueOf(userName))
				.build();
	}
